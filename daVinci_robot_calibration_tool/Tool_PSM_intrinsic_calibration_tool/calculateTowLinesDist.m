...
%
% Notes.
% 1. % https://en.wikipedia.org/wiki/Skew_lines#Distance

% param@a: a point that line 1 passes through
% param@b: direction vector of line 1
% param@c: a point that line 2 passes through
% param@d: direction vector of line 2
function [dist] = calculateTowLinesDist(a, b, c, d, fig_flag, fig_name)
% If the lines are parallel and this method cannot be used!

% line_1 = a (fixed point) + t*b
% line_2 = c (fixed point) + t*d
