...
function [result_map] = createPostProcessingHashTablesSimulation(j1_arc_mat, j2_arc_mat, small_sphere_01_mat, ...
    small_sphere_02_mat, small_sphere_03_mat, small_sphere_04_mat, ...
    plot_flag, save_file_path)
...
%% Fitting.
    ...
    [small_sphere_param_1, small_residuals_1] = fitSphereLeastSquare(small_sphere_01_mat);
    [small_sphere_param_2, small_residuals_2] = fitSphereLeastSquare(small_sphere_02_mat);
    [small_sphere_param_3, small_residuals_3] = fitSphereLeastSquare(small_sphere_03_mat);
    [small_sphere_param_4, small_residuals_4] = fitSphereLeastSquare(small_sphere_04_mat);
...
% file.
    ...
    [affine_dh_0_wrt_polaris, affine_dh_1_wrt_polaris, affine_base_wrt_polaris] = ...
        defineBaseFrameAndDhFrame0And1FromArcs(j1_arc_mat, j2_arc_mat, save_file_path);
...
%% RMS
    ...
    rms_SmallSphere01 = calculateSphereRms(small_sphere_01_mat, small_sphere_param_1(1:3), small_sphere_param_1(4));
    rms_SmallSphere02 = calculateSphereRms(small_sphere_02_mat, small_sphere_param_2(1:3), small_sphere_param_2(4));
    rms_SmallSphere03 = calculateSphereRms(small_sphere_03_mat, small_sphere_param_3(1:3), small_sphere_param_3(4));
    rms_SmallSphere04 = calculateSphereRms(small_sphere_04_mat, small_sphere_param_4(1:3), small_sphere_param_4(4));
