...
% 01/07/18
% Notes.
% This function depends on circlefit3d.m (Can we get rid of it thoug..)

% WARNING: THIS FUNCTION IS VERY SLOW.

% @circle_params: centre coordinate x y z and radius r. 
function [circle_params, arc_plane_norm, fval, rms] = davinciFit3dCircle_MkX(pt_mat)
...
% return this var.
arc_plane_norm = arc_plane.Normal();
