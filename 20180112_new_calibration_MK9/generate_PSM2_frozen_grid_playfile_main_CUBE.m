...
for i = 0:6
   ...
   for j = 0:6
       ...
       for k = 0:6
          ...
          disp( strcat('0, 0, -0.15, 0,1,0, 0, 0, -1, 0,', num2str(point(1)), ',  ', num2str(point(2)), ',  ' , num2str(point(3)), ',0,1,0, 0, 0, -1, -1,', num2str(time)));
          disp( strcat('0, 0, -0.15, 0,1,0, 0, 0, -1, 0,', num2str(point(1)), ',  ', num2str(point(2)), ',  ' , num2str(point(3)), ',0,1,0, 0, 0, -1, -1,', num2str(time + 2))); 
